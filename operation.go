...
type OperationDoc struct {
	...
	Responses *ResponsesDoc `json:"responses"`
	...
	// by the API provider and the expected responses. The key value used to identify the callback object is
	// an expression, evaluated at runtime, that identifies a URL to use for the callback operation.
	...
	// need to be satisfied to authorize a request. This definition overrides any declared top-level security.
